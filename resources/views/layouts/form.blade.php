...
<body class="bg-default">
  <div class="main-content">
          ...
          <ul class="navbar-nav ml-auto">
            ...
            <li class="nav-item">
              <a class="nav-link nav-link-icon" href="{{ route('login') }}">
                ...
                <span class="nav-link-inner--text">Acceso</span>
              </a>
            </li>
          </ul>
        </div>
    ...
    <!-- Page content -->
    @yield('content') {{-- definimos una sección --}}
    <!-- Footer -->
    <footer class="py-5">
      <div class="container">
        <div class="row align-items-center justify-content-xl-between">
          <div class="col-xl-6">
            <div class="copyright text-center text-xl-left text-muted">
              © 2013 <a href="https://www.creative-tim.com" class="font-weight-bold ml-1">{{ config('app.name') }}</a>
            </div>
          </div>
          <div class="col-xl-6">
